			...
			if err != nil && errors.IsNotFound(err) {
				resource := &firewallv1alpha1.FirewallRule{
					...
					Spec: firewallv1alpha1.FirewallRuleSpec{
						...
						Action:    "pass",
						Direction: "in",
						Source: firewallv1alpha1.FirewallRuleEndpoint{
							Net: "any",
						},
						Destination: firewallv1alpha1.FirewallRuleEndpoint{
							Net: "any",
						},
					},
				}
